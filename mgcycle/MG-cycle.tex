...
\put(-0.4,4.9){\scriptsize Finest}
\put(-0.4,0.9){\scriptsize Coarsest}
...
\put(-1.2,4.9){\scriptsize Finest}
\put(-1.2,0.9){\scriptsize Coarsest}
...
\ncline[linecolor=red, linewidth=0.04cm]{->}{V6}{V7}
%
\rput(5.6, 0.0){Cascade multigrid}
%
\rput(2.5,4){\scriptsize Finest} %{×îÏž²ã}
\rput(2.5,1){\scriptsize Coarsest}%{×îŽÖ²ã}
%\put(0,4.9){\scriptsize Finest}
%\put(0,0.5){\scriptsize Coarsest}
%
\cnodeput*[linecolor=black, fillcolor=black](6.0,4.0){V16}{ }
\put(6.5,4.0){\scriptsize Relaxation} %{Ä¥¹â}
\cnodeput[linecolor=black](6.0,3.0){V17}{ }
\put(6.5,3.0) {\scriptsize Exact solving} %{Ÿ«È·Çóœâ}
\psline[linecolor=blue, linewidth=0.04cm]{->}(5.8,2.5)(6.2,1.8)
\put(6.5,2.0){\scriptsize Restriction} %{ÏÞÖÆ}
\psline[linecolor=red, linewidth=0.04cm]{->}(5.8,0.8)(6.2,1.4)
\put(6.5,1.0){\scriptsize Prolongation} %{ÌáÉýÐ£Õý}
\end{pspicture}
  \caption{Cascade multigrid method} 
\end{center}
\end{figure}
...
\put(-32, 28){\textcolor{red}{{Prolongation}}}
\put(88, 43){\textcolor{blue}{\vector(0, -1){25}}}
\put(91, 28){\textcolor{blue}{{Restriction}}}
\put(85, 5){Coarsest Grid}
\put(85, 52){Finest Grid}
\end{picture}
\end{center}
\vskip -0.5cm
%
...
\ncline[linecolor=red, linewidth=0.04cm]{->}{V6}{V7}
%
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{V1}{V7}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{V2}{V6}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{V3}{V5}
%
\rput(3.6, 0.0){V-cycle}
%
% W-cycle
...
\ncline[linecolor=red, linewidth=0.04cm]{->}{w14}{w15}
%
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w1}{w15}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w2}{w8}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w8}{w14}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w3}{w5}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w5}{w7}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w9}{w11}
\ncline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}{w11}{w13}
%
\rput(10.6, 0.0){W-cycle}
%
\rput(1,4){\scriptsize Finest} %{×îÏž²ã}
...
%
\cnodeput*[linecolor=black, fillcolor=black](15.0,4.0){V16}{ }
\put(15.5,3.9){\scriptsize Relaxation} %{Ä¥¹â}
\cnodeput[linecolor=black](15.0,3.25){V17}{ }
\put(15.5,3.15) {\scriptsize Exact solving} %{Ÿ«È·Çóœâ}
\psline[linecolor=blue, linewidth=0.04cm]{->}(14.8,2.65)(15.2,2.15)
\put(15.5,2.3){\scriptsize Restriction} %{ÏÞÖÆ}
\psline[linecolor=red, linewidth=0.04cm]{->}(14.8,1.3)(15.2,1.8)
\put(15.5,1.45){\scriptsize Prolongation} %{ÌáÉýÐ£Õý}
\psline[linecolor=black, linestyle=dashed, linewidth=0.02cm]{->}(14.8,0.75)(15.2,0.75)
\put(15.5,0.65){\scriptsize Addition} %{ÌáÉýÐ£Õý}
\end{pspicture}
%
  \caption{V-cycle and W-cycle} 
\end{center}
